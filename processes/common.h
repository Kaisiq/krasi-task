...
const char *get_color_code(int color_num, int is_bg) {
  ...
  const char *txt_colors[] = {TXT_BLACK, TXT_RED,     TXT_GREEN, TXT_YELLOW,
                              TXT_BLUE,  TXT_MAGENTA, TXT_CYAN,  TXT_WHITE};
  const char *bg_colors[] = {BG_BLACK, BG_RED,     BG_GREEN, BG_YELLOW,
